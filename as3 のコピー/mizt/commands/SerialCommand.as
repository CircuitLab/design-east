package mizt.commands {
	...
	public class SerialCommand extends BatchCommand {
		// comamndArray ICommandインターフェースを実装したコマンドの配列。
		public function SerialCommand( commandArray:Array = null) { super(commandArray); }
		
		override public function execute():void { doNext(); }
		...
		protected function doNextCompleteHandler(e:Event):void {
			...
			if((++_index)==_commands.length) this.dispatchComplete();
			else doNext();	
		}
	}
}